...
Актуальность зафиксирована на **июль 2026**: Swift 6.3 · Xcode 26 ·
macOS 26 Tahoe SDK (дизайн-язык Liquid Glass; macOS 27 Golden Gate его
сохраняет). Deployment target — **macOS 26**: приложение для собственного
Mac разработчика, `#available`-ветки не заводим. Всё, что изменилось в 2024–2026 и противоречит старым статьям
...
- **Иконка старого macOS-стиля мертва**: слоёная Liquid Glass иконка из
  Icon Composer (default/dark/mono), системный squircle.
