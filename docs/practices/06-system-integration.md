...
Версии, на которые рассчитан текст: **Swift 6.3 / Xcode 26**, **swift-subprocess 0.5.x**, **GRDB 7.x (7.11+)**, deployment target — macOS 26 (вердикт серии: приложение для собственного Mac, `#available`-ветки не заводим; сами API ниже доступны с macOS 14–15). Проверено на состояние июля 2026.
