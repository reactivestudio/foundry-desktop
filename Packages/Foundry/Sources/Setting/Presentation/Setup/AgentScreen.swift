...
struct AgentScreen: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            SetupTitle(text: "Agent")
            SetupSubtitle(text: "Foundry runs the stages, it writes no code\nChoose who does")
            HStack(spacing: 24) {
    ...
    private func card(
        id: ToolId, glyph: SetupGlyph, vendor: String, name: String, requirement: String
    ) -> InstallCardModel {
