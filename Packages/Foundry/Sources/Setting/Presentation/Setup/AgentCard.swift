...
struct AgentCard: View {
    ...
    var body: some View {
        ...
        .animation(SetupStyle.easeReal(0.15), value: isSelected)
    }
    ...
    private var vendorChip: some View {
        Text(card.vendor)
            ...
            .tracking(1.1)
            .textCase(.uppercase)
            .foregroundStyle(SetupStyle.Text.tertiary)
    ...
    private var cardFill: some View {
        ZStack {
            ...
            if isSelected { SetupStyle.ultramarine.opacity(0.06) }
        }
    }

    @ViewBuilder private var selectionOverlay: some View {
        if isSelected {
            SetupStyle.squircle(SetupStyle.cardRadius)
                .strokeBorder(SetupStyle.ultramarine.opacity(0.75), lineWidth: 2)
        }
    }
}
