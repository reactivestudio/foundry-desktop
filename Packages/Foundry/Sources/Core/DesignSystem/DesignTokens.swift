...
public enum Token {
    ...
    public enum Background {
        ...
        public static let surface = Color(hexValue: 0x0B0717)
        /// поповеры, меню, тултипы, sticky-заголовки
        public static let raised = Color(hexValue: 0x120B23)
        /// модалки/шиты (плюс скрим под ними)
        public static let overlay = Color(hexValue: 0x1A1030)
    ...
    public enum Text {
        ...
        public static let primary = Color(white: 1, opacity: 1)
